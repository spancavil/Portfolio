...
type HomePageLayoutProps = {
  ...
  lessPaddingX?: boolean
}

const HomePageLayout = ({ children, lessPaddingX = false }: HomePageLayoutProps) => {

  const paddingX = lessPaddingX ? `px-3 md:px-5 ` : `px-5 md:px-40 `
  return (
      <div className={"w-full py-2 " + paddingX + "md:py-10 bg-black border-dashed border-[1px] border-light-gray border-opacity-80 relative"}>
        {/* RIGHT */}
